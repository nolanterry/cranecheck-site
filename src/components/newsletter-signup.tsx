...
const STORAGE_KEY = "cranecheck-newsletter-subscribed";
    ...
    if (status === "success") {
      return (
        <div className="my-12 rounded-xl border border-brand/20 bg-brand-light p-8 text-center">
          ...
          <p className="text-sm text-gray-600 mt-1">We&apos;ll send you crane inspection tips and compliance updates.</p>
        </div>
      );
    }
    return null;
  ...
  return (
    <div className="my-12 rounded-xl border-2 border-brand/20 bg-gradient-to-br from-brand-light to-white p-8" role="region" aria-label="Newsletter signup">
      <div className="text-center">
        <p className="text-2xl font-bold text-gray-900">🚧 Stay OSHA-Ready</p>
        <p className="text-gray-600 mt-2 max-w-md mx-auto">
          Get crane inspection tips, compliance updates, and regulatory changes — straight to your inbox. No spam, unsubscribe anytime.
        </p>
      </div>
