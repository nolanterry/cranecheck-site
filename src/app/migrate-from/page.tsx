...
export const metadata: Metadata = {
  title: "Migrate to CraneCheck | Switch from Any Crane Inspection Tool",
  description:
    "Step-by-step migration guides to switch to CraneCheck from InspectAll, HVI, paper logs, or spreadsheets. Zero data loss. Free onboarding support.",
  openGraph: {
    title: "Migrate to CraneCheck | Switch from Any Crane Inspection Tool",
    description:
      "Step-by-step migration guides to switch to CraneCheck. Zero data loss. Free onboarding support.",
    url: "https://cranecheck.co/migrate-from",
  },
...
const structuredData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Migration Guides", item: "https://cranecheck.co/migrate-from" },
  ],
};
...
const benefits = [
  {
    icon: Clock,
    title: "Under 1 Hour",
    description: "Most teams complete the full migration in under 60 minutes, including data import and team setup.",
  },
  {
    icon: Shield,
    title: "Zero Data Loss",
    description: "Your inspection history, equipment records, and compliance documentation transfer completely.",
  },
  {
    icon: Users,
    title: "Free Onboarding",
    description: "Our team helps with data migration, template setup, and inspector training at no extra cost.",
  },
];
        ...
        <section className="bg-gradient-to-br from-navy via-navy to-orange/10 text-white py-20">
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Switch to CraneCheck — No Data Left Behind
            </h1>
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Step-by-step guides to migrate from your current crane inspection tool. Import your data, keep your history, and be up and running in under an hour.
            </p>
          </div>
        </section>
              ...
              {benefits.map((b, i) => (
                <div key={i} className="text-center">
                  <div className="w-12 h-12 bg-orange/10 rounded-lg flex items-center justify-center mx-auto mb-4">
                    <b.icon className="w-6 h-6 text-orange" />
                  </div>
        ...
        <section className="py-20 bg-gradient-to-br from-navy to-navy/90 text-white">
          <div className="max-w-3xl mx-auto px-4 text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              We can help you migrate from any crane inspection system. Contact our team for a custom migration plan.
            </p>
