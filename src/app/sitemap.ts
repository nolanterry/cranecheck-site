...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const blogSlugs = [
    ...
    "crane-anti-two-block-safety",
    "crane-operator-fatigue-management",
    "crane-hot-weather-operations",
    "crane-clearance-requirements-structures",
    "telescopic-boom-crane-inspection-checklist",
    "crane-night-operations-lighting",
    "crane-stabilizer-pad-requirements",
    "crane-near-miss-reporting",
    "crane-insurance-requirements-coverage",
    "osha-multi-employer-crane-liability",
    "crane-foundation-pier-requirements",
    "crane-electrical-system-inspection",
    "crane-boom-inspection-guide",
    "crane-load-testing-requirements",
    "crane-emergency-shutdown-procedures",
    "crane-pre-erection-planning-guide",
    "crane-fleet-management-preventive-maintenance",
    "overhead-crane-runway-rail-inspection",
    "bridge-gantry-crane-inspection-checklist",
    "post-incident-crane-reinspection",
    "crane-modification-alteration-inspection",
    "crane-capacity-derating-factors",
    "crane-inspection-technology-drones-iot",
    "crane-safety-meeting-topics-toolbox-talks",
    "rough-terrain-crane-inspection-checklist",
    "all-terrain-crane-inspection-guide",
    "suspended-personnel-platform-inspection",
    "crane-inspection-petrochemical-refinery",
    "crane-inspection-wind-energy-renewable",
    "knuckle-boom-crane-inspection-articulating",
    "crane-inspection-mining-operations",
    "crane-operator-training-program-requirements",
    "crane-signal-person-requirements",
    "crane-load-chart-reading-guide",
    "crawler-crane-inspection-checklist",
    "crane-boom-inspection-deficiency-guide",
    "crane-insurance-requirements-contractors",
    "crane-winter-cold-weather-operations",
    "crane-ground-bearing-pressure-calculations",
    "crane-inspection-drone-technology",
    "port-container-crane-inspection",
    "jib-crane-inspection-checklist",
    "crane-operator-medical-requirements",
    "crane-proximity-detection-systems",
    "crane-inspection-steel-erection",
    "crane-weathervaning-out-of-service",
    "crane-inspection-nuclear-power-plant",
    "rigging-hardware-inspection-shackles-turnbuckles",
    "crane-operator-hand-signals",
    "tower-crane-climbing-jacking-safety",
    "crane-inspection-bridge-highway-construction",
    "crane-counterweight-inspection",
    "concrete-pump-boom-inspection",
    "crane-inspection-data-center-construction",
    "crane-tire-wheel-inspection",
    "crane-inspection-shipyard-maritime",
