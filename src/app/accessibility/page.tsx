...
export const metadata: Metadata = {
  ...
  description: "CraneCheck is committed to ensuring digital accessibility for people with disabilities. We continually improve the user experience for everyone.",
        ...
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="prose prose-gray max-w-none space-y-6">
            <p className="text-gray-600 leading-relaxed">
              CraneCheck is committed to ensuring digital accessibility for people with disabilities.
            ...
            <p className="text-gray-600 leading-relaxed">
              We welcome your feedback on the accessibility of CraneCheck. If you encounter
            ...
            <p className="text-gray-600 leading-relaxed">
              CraneCheck is designed to be compatible with the following assistive technologies:
            </p>
            <ul className="list-disc pl-6 text-gray-600 space-y-2">
