...
export async function generateMetadata({ params }: CaseStudyPageProps): Promise<Metadata> {
  ...
  if (!caseStudy) {
    return {
      title: "Case Study Not Found — CraneCheck",
    };
  }

  return {
    title: `${caseStudy.companyName} Case Study — CraneCheck`,
  ...
  const structuredData = {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "position": 2,
        "name": "Customers",
        "item": "https://cranecheck.co/customers"
      },
      {
        "@type": "ListItem",
        "position": 3,
        "name": caseStudy.companyName,
        "item": `https://cranecheck.co/customers/${slug}`
      }
    ]
  };
        ...
        <section className="py-16 bg-brand text-white">
          <div className="max-w-4xl mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold mb-4">
              Ready to Transform Your Crane Inspections?
            </h2>
            <p className="text-lg text-orange-100 mb-8 max-w-2xl mx-auto">
              See how CraneCheck can help your company achieve the same results. 
