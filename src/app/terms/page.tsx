...
export const metadata: Metadata = {
  ...
  description: "CraneCheck terms of service — the agreement between you and CraneCheck.",
    ...
    <>
      ...
      <main id="main-content" className="py-20 bg-white">
        <article className="max-w-3xl mx-auto px-4 prose prose-gray">
          ...
          <p>
            These Terms of Service (&quot;Terms&quot;) govern your access to and use of CraneCheck&apos;s
            crane inspection compliance platform, including our website, applications, and services
            (collectively, the &quot;Service&quot;). By using the Service, you agree to these Terms.
          </p>

          <h2>1. Account Registration</h2>
          <p>
            You must create an account to use CraneCheck. You are responsible for maintaining the
          ...
          <h2>4. Your Data</h2>
          <p>
            You retain ownership of all inspection data, photos, reports, and other content you create
            or upload to CraneCheck (&quot;Your Data&quot;). You grant us a limited license to host,
            store, and process Your Data solely to provide and improve the Service. We will not share
          ...
          <p>
            CraneCheck is provided &quot;as is&quot; and &quot;as available.&quot; While we design our
            platform to support OSHA compliance workflows (29 CFR 1926 Subpart CC), CraneCheck is a
            tool to assist your compliance processes — it does not constitute legal advice and does not
            guarantee regulatory compliance. You remain responsible for ensuring your inspection
            programs meet applicable federal, state, and local requirements.
          </p>

          <h2>8. Limitation of Liability</h2>
          <p>
            To the maximum extent permitted by law, CraneCheck&apos;s total liability for any claims
          ...
          <p>
            You agree to indemnify and hold harmless CraneCheck and its officers, employees, and
