...
export default function CraneMaintenanceLogRequirementsPage() {
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://cranecheck.co/blog/crane-maintenance-log-requirements"
  }
};
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://cranecheck.co/blog/crane-maintenance-log-requirements"
    }
  ]
};
    ...
    <>
      ...
      <main id="main-content">
        ...
        <section className="bg-navy py-16 px-4">
          ...
          <div className="not-prose max-w-3xl mx-auto px-4"><RelatedPosts currentSlug="crane-maintenance-log-requirements" /><NewsletterSignup /></div>
      </main>
      <Footer />
    </>
  );
