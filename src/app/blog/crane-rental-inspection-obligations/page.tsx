...
export default function CraneRentalInspectionObligationsPage() {
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://cranecheck.co/blog/crane-rental-inspection-obligations"
  }
};
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://cranecheck.co/blog/crane-rental-inspection-obligations"
    }
  ]
};
    ...
    <>
      ...
      <main id="main-content">
        ...
        <section className="bg-navy py-16 px-4">
          ...
          <div className="not-prose max-w-3xl mx-auto px-4"><RelatedPosts currentSlug="crane-rental-inspection-obligations" /><NewsletterSignup /></div>
      </main>
      <Footer />
    </>
  );
