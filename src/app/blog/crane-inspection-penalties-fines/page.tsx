...
export default function CraneInspectionPenaltiesFinesPage() {
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://cranecheck.co/blog/crane-inspection-penalties-fines"
  }
};
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://cranecheck.co/blog/crane-inspection-penalties-fines"
    }
  ]
};
    ...
    <>
      ...
      <main id="main-content">
        ...
        <article className="py-16 bg-white">
          ...
          <div className="not-prose max-w-3xl mx-auto px-4"><RelatedPosts currentSlug="crane-inspection-penalties-fines" /><NewsletterSignup /></div>
      </main>
      <Footer />
    </>
  );
