...
const QUICK_FACTS = [
  {
    ...
    cranecheck: "All types: mobile, tower, overhead",
    inspectall: "Overhead cranes only (OSHA 1910.179)",
    winner: "cranecheck"
  },
  {
    category: "Trial Availability", 
    cranecheck: "14-day free trial, no credit card",
    inspectall: "Contact sales required",
    winner: "cranecheck"
  },
  {
    category: "Industry Focus",
    cranecheck: "Crane-only specialization",
    inspectall: "Multi-industry (hospitals, facilities)", 
    winner: "cranecheck"
  },
  {
    category: "Target Market",
    cranecheck: "All sizes: operators to enterprise",
    inspectall: "Enterprise service providers only",
    winner: "cranecheck"
  }
];
  ...
  return (
    <div className="bg-white rounded-xl p-6 border border-gray-200">
      ...
      <div className="space-y-3">
        <div className={`flex items-start gap-3 p-3 rounded-lg ${fact.winner === 'cranecheck' ? 'bg-green-50 border border-green-200' : 'bg-gray-50'}`}>
          {fact.winner === 'cranecheck' ? (
            <Check className="text-green-500 mt-0.5 flex-shrink-0" size={16} />
          ) : (
            <div className="w-4 h-4 mt-0.5 flex-shrink-0" />
          )}
          <div>
            <div className="font-medium text-brand mb-1">CraneCheck</div>
            <div className="text-sm text-gray-600">{fact.cranecheck}</div>
          </div>
        </div>
        <div className={`flex items-start gap-3 p-3 rounded-lg ${fact.winner === 'inspectall' ? 'bg-green-50 border border-green-200' : 'bg-gray-50'}`}>
          {fact.winner === 'inspectall' ? (
            <Check className="text-green-500 mt-0.5 flex-shrink-0" size={16} />
          ) : (
            <X className="text-red-400 mt-0.5 flex-shrink-0" size={16} />
          )}
          <div>
            <div className="font-medium text-gray-900 mb-1">InspectAll</div>
            <div className="text-sm text-gray-600">{fact.inspectall}</div>
          </div>
        </div>
      </div>
    </div>
...
export default function InspectAllComparisonPage() {
  return (
    <>
      <Header />
      <main>
        ...
        <section className="bg-gradient-to-br from-navy via-navy-light to-navy py-20 px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6 text-white">
              CraneCheck vs InspectAll:<br />
              <span className="text-brand">Which Crane Inspection Software Is Right for You?</span>
            </h1>
            <p className="text-lg text-gray-300 max-w-3xl mx-auto">
              Both platforms help with crane inspections, but they serve different markets and crane types. 
          ...
          <div className="max-w-5xl mx-auto px-4">
            ...
            <div className="grid lg:grid-cols-2 gap-12 mb-16">
              ...
              <div className="space-y-8">
                <div className="text-center">
                  <h3 className="text-2xl font-bold text-brand mb-2">CraneCheck</h3>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-green-50 rounded-xl p-6 border border-green-200">
                <h3 className="text-xl font-bold text-green-800 mb-4">Choose CraneCheck if you:</h3>
            ...
            <div className="space-y-8">
              <div className="bg-blue-50 rounded-xl p-6 border border-blue-200">
                ...
                <p className="text-blue-800 text-sm">
                  CraneCheck is purpose-built for your needs. You'll get mobile crane (1926.1412) and tower crane (1926.1435) 
              ...
              <div className="bg-purple-50 rounded-xl p-6 border border-purple-200">
                ...
                <p className="text-purple-800 text-sm">
                  Both platforms support OSHA 1910.179 compliance. CraneCheck offers faster setup and transparent pricing, 
              ...
              <div className="bg-green-50 rounded-xl p-6 border border-green-200">
                ...
                <p className="text-green-800 text-sm">
                  Start with CraneCheck's free trial to see if it meets your needs. It covers more crane types, 
