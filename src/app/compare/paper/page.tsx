...
export const metadata: Metadata = {
  title: "CraneCheck vs Paper Logs Comparison",
  description: "Compare digital crane inspection software to paper logs. CraneCheck saves 520+ hours annually, provides instant record retrieval, and prevents $165K OSHA fines.",
...
const PAIN_POINTS = [
  {
    ...
    paperPain: "OSHA arrives. You need inspection records for Crane #47 from September 15th. Start digging through binders in the job trailer.",
    digitalSolution: "Search 'Crane 47' → September 15th record appears in 3 seconds. PDF downloaded to inspector's tablet instantly."
  },
  {
    icon: AlertTriangle,
    title: "Compliance Risk", 
    paperPain: "78% of OSHA crane citations involve documentation failures. Paper gets lost, damaged, or illegible. 'It was in the truck' isn't an acceptable answer.",
    digitalSolution: "Records automatically synced to cloud. Every inspection backed up. Deficiencies tracked through resolution. Zero lost documentation."
  },
  {
    icon: Clock,
    title: "Time Cost",
    paperPain: "15 minutes per paper inspection. 10-crane fleet = 25 hours/week. Plus time lost hunting for records during audits.",
    digitalSolution: "3-minute digital inspections. Same fleet = 5 hours/week. 520 hours saved annually = $26K in labor costs."
  },
  {
    icon: Camera,
  ...
  },
  {
    ...
    paperPain: "OSHA wants 3 months of records for all cranes. You spend days collecting binders, copying illegible forms, explaining missing documentation.",
        ...
        <section className="bg-gradient-to-br from-navy via-navy-light to-navy py-20 px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6 text-white">
              CraneCheck vs Paper Crane Inspection Logs:<br />
              <span className="text-brand">The Full Comparison</span>
            </h1>
            <p className="text-lg text-gray-300 max-w-3xl mx-auto">
              Paper inspection logs seem free, but they cost crane companies over $23,000 annually in lost productivity, 
          ...
          <div className="max-w-6xl mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                These aren't marketing claims. They're based on real data from crane companies that made the switch.
              </p>
            </div>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <div className="text-xs text-gray-400 mt-1">10-crane fleet</div>
              </div>
              <div className="text-center">
              ...
              <div className="text-center">
                ...
                <div className="text-sm text-gray-600">OSHA citations involve docs</div>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-5xl mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Paper appears free, but the hidden costs add up fast. Here's the actual annual impact for a typical 10-crane operation.
              </p>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12">
              ...
              {/* Digital Solution */}
              <div>
                <h3 className="text-2xl font-bold mb-6 text-green-700">CraneCheck Digital Solution</h3>
                <div className="space-y-4">
                  <div className="p-4 bg-green-50 rounded-lg border border-green-100">
                    <div className="font-medium text-green-900">CraneCheck Annual Cost</div>
                  ...
                  <div className="space-y-3 text-sm text-green-700">
                    <div className="flex items-center gap-2">
                      <Clock size={16} />
                      <span>12-minute time savings per inspection</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <Search size={16} />
        ...
        <section className="py-20 bg-white">
          <div className="max-w-4xl mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">OSHA Audit Reality Check</h2>
              <p className="text-gray-600 max-w-2xl mx-auto">
                What actually happens when OSHA shows up and wants to see your crane inspection records?
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-green-50 rounded-xl p-6 border border-green-200">
                <h3 className="text-xl font-bold text-green-800 mb-4">📱 CraneCheck Scenario</h3>
                <div className="space-y-3 text-sm text-green-700">
                  <p><strong>9:15 AM:</strong> OSHA arrives unannounced</p>
                  <p><strong>9:30 AM:</strong> Inspector asks for 90 days of records for all cranes</p>
                  <p><strong>9:32 AM:</strong> You open CraneCheck, select date range</p>
