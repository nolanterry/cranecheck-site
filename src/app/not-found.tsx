...
export const metadata: Metadata = {
  title: "Page Not Found — CraneCheck",
  description: "The page you're looking for doesn't exist. Browse our crane inspection software features, pricing, blog, and more.",
};

const suggestions = [
  { href: "/", label: "Home", desc: "Back to the homepage" },
  { href: "/features", label: "Features", desc: "See what CraneCheck can do" },
  { href: "/pricing", label: "Pricing", desc: "Simple, transparent plans" },
  { href: "/blog", label: "Blog", desc: "Crane inspection tips & compliance guides" },
  { href: "/demo", label: "Book a Demo", desc: "See CraneCheck in action" },
