...
export const metadata: Metadata = {
  title: "System Status",
  description:
    "CraneCheck system status — real-time operational status for all crane inspection compliance services. Check uptime, incidents, and scheduled maintenance.",
...
const SERVICES: Service[] = [
    { name: "Inspection Engine", status: "operational" as const },
    { name: "Photo & Document Storage", status: "operational" as const },
    { name: "PDF Report Generation", status: "operational" as const },
