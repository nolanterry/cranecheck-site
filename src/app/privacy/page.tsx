...
export const metadata: Metadata = {
  ...
  description: "CraneCheck privacy policy — how we collect, use, and protect your data.",
    ...
    <>
      ...
      <main className="py-20 bg-white">
        <article className="max-w-3xl mx-auto px-4 prose prose-gray">
          ...
          <p>
            CraneCheck (&quot;we,&quot; &quot;us,&quot; or &quot;our&quot;) operates the CraneCheck
            crane inspection compliance platform. This Privacy Policy explains how we collect, use,
          ...
          <ul>
            ...
            <li><strong>Inspection data:</strong> Crane inspection records, photos, deficiency notes, equipment details, and compliance documentation you enter into the platform.</li>
          ...
          <ul>
            <li><strong>Usage data:</strong> Pages visited, features used, inspection completion patterns, and session duration.</li>
          ...
          <ul>
            <li>Provide, maintain, and improve the CraneCheck platform</li>
          ...
          <p>
            ...
            encryption at rest, access controls, and regular security assessments. Inspection data and
            compliance records are stored in SOC 2-compliant infrastructure.
          </p>

          <h2>5. Data Retention</h2>
          <p>
            We retain your account information and inspection data for as long as your account is active
            or as needed to provide services. Inspection records may be retained longer to support OSHA
            compliance requirements (typically 5+ years per 29 CFR 1926.1412). You may request deletion
          ...
          <p>
            CraneCheck is not intended for use by individuals under 18 years of age. We do not
